...
- Para operaciones de GitHub en este proyecto, usar siempre la cuenta `guideahon`. Si las credenciales activas no corresponden a esa cuenta, no pushear y reportar el bloqueo.
